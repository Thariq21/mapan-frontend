export default function Footer() {
  return (
    <footer
      className="border-t border-surface-200 bg-surface-900 text-surface-400"
      id="footer"
    >
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              ...
              Temukan jalur pertumbuhan karirmu.
            </p>
          </div>
          ...
          <nav aria-label="Platform">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#gaji" className="hover:text-white transition-colors">
                  Eksplorasi Gaji
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-surface-800 pt-8 sm:flex-row">
          <p className="text-xs text-surface-500">
            © 2026 MAPAN. Semua hak dilindungi.
          </p>
