  ...
  const fetchSalaryData = async (queryJob = "", queryLoc = "") => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_DS_URL}/api/salary-distribution`,
        {
          params: {
      ...
      return (
        <div className="bg-white p-4 rounded-xl shadow-lg border border-gray-100">
          ...
          <p className="text-sm text-gray-500 mb-2">
            {itemData.company_name} &bull; {itemData.location}
          </p>
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <header className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-500">
            Temukan insight data gaji dan tren kompensasi berdasarkan data
            nyata.
          </p>
        </header>
            ...
            {!isLoading && !error && data.length === 0 && (
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/80 rounded-xl border-2 border-dashed border-gray-200">
                ...
                <p className="text-gray-500 text-center max-w-md">
                  Tidak ada data gaji yang sesuai dengan kriteria pencarian
                  Anda. Coba kata kunci atau lokasi lain.
                </p>
              </div>
            )}
            ...
            <table className="w-full text-left border-collapse min-w-150">
              <thead>
                <tr className="bg-gray-50 text-gray-500 text-xs uppercase tracking-wider border-b border-gray-100">
                  <th className="p-4 md:px-8 md:py-5 font-semibold">
                    Posisi Pekerjaan
                  </th>
              ...
              <tbody className="divide-y divide-gray-100 text-gray-700 text-sm md:text-base">
                {isLoading ? (
                  ...
                  data.map((row, index) => (
                    ...
                    >
                      <td className="p-4 md:px-8 md:py-5 font-semibold text-gray-900">
                        {row.job_title}
                      </td>
                      ...
                      <td className="p-4 md:px-8 md:py-5 text-gray-500">
                        {row.company_name}
                      </td>
                    </tr>
                  ))
