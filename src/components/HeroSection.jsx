  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute -top-32 -left-32 h-[500px] w-[500px] rounded-full bg-primary-400/10 blur-3xl animate-float" />
        <div className="absolute -bottom-40 -right-40 h-[600px] w-[600px] rounded-full bg-accent-400/8 blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[300px] w-[300px] rounded-full bg-primary-200/10 blur-2xl" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 pt-24 pb-16 text-center max-w-5xl">
        ...
        <h1 className="animate-fade-in-up-delay-1 text-4xl font-bold leading-tight tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
          Temukan Jalur{' '}
          <span className="gradient-text">Pertumbuhan</span>{' '}
        ...
        <div className="animate-fade-in-up-delay-3 mx-auto mt-12 flex flex-wrap items-center justify-center gap-8 text-sm text-gray-500">
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-gray-800">12.000+</strong> Perusahaan</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-gray-800">50.000+</strong> Ulasan</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-gray-800">8.500+</strong> Data Gaji</span>
          </div>
        </div>
      </div>
    </section>
